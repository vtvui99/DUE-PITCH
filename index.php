            ...
            <article class="main-content">
                ...
                <div id="tab-1" class="tabcontent">
                    <ol type="1">
                        ...
                        <li>Người đăng kí sử dụng tài khoản của mình và chịu hoàn toàn trách nhiệm khi có vấn đề xảy ra.
                        </li>
                        <li>Trong quá trình đăng kí cần kiểm tra kỹ lịch và thời gian đăng kí, tránh trường hợp đăng kí
                            trùng hoặc đăng kí sai.</li>
                    </ol>
                    <h3 class="alert">Lưu ý về việc hủy sân:</h3>
                    <ul>
                        <li>- Nếu muốn hủy lịch đã đăng kí trên web, phải liên hệ đến Trung tâm hỗ trợ sinh viên và Quan
                            hệ doanh nghiệp theo số điện thoại 0935120488 – gặp Lê Duy.</li>
                        <li>- Nếu sinh viên đã đăng kí sân nhưng không sử dụng theo đúng lịch đã đăng kí sẽ bị phạt theo
                            quy định của Trung tâm (100k/1 lần đăng kí).</li>
                    </ul>
                </div>

                <div id="tab-2" class="tabcontent">
                    <ol type="1">
                        <li>Chỉ có thành viên theo quy định của Ban tổ chức giải được tham gia thi đấu và trong khu vực
                            sân bóng.</li>
                        <li>Thi đấu với tinh thần trung thực, cao thượng và fair-play.</li>
                        <li>Không mang giày đinh nhọn, các vật dụng nguy hiểm và gây cháy nổ trong thời gian thi đấu.
                        </li>
                        ...
                        <li>Không đem đồ ăn, không xả rác trong khu vực thể thao, sân bóng, có ý thức giữ vệ sinh chung.
                        </li>
                        <li>Tất cả các cầu thủ, khán giả đến khu thể thao gửi xe đúng nơi quy định (bãi xe trường hoặc
                            khu Kí túc xá).</li>
                    </ol>
                    <h4 class="alert">Nếu vi phạm nội quy, quy định và các cam kết trên sẽ chịu trách nhiệm và các hình
                        thức xử lý kỷ luật của Nhà trường. </h4>
                </div>
            </article>
        </div>
    </section>
